 ...
 * @generated
 */
public class SimplStateMachineDCSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SimplStateMachineDCSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimplStateMachineDCPackage.STATE_MACHINE: {
				StateMachine stateMachine = (StateMachine)theEObject;
				T result = caseStateMachine(stateMachine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimplStateMachineDCPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimplStateMachineDCPackage.COMPOSITE_STATE: {
			...
			case SimplStateMachineDCPackage.PSEUDO_STATE: {
			...
			case SimplStateMachineDCPackage.INITIAL_STATE: {
			...
			case SimplStateMachineDCPackage.TRANSITION: {
